...
class P4_Simulation:
    ...
    def __init__(self, topo_file, test_file, log_dir, pcap_dir,
        ...
        """ Initializes some attributes and reads the topology json. Does not
            actually run the exercise. Use run() for that.
    ...
    def create_network(self):
        ...
        self.topo = Topology(self.hosts, self.switches, self.links, self.log_dir, self.bmv2_exe, self.pcap_dir)
...
if __name__ == '__main__':
    ...
    args = get_args()
    simulation = P4_Simulation(args.topo, args.test, args.log_dir, args.pcap_dir,
