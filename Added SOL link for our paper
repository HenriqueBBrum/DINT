...
To reproduce the results obtained in the paper [DINT: A Dynamic Algorithm for In-band Network Telemetry](https://sol.sbc.org.br/index.php/sbrc/article/view/24541), three tests need to be executed:
