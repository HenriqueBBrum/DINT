...
def main():
    ...
    os.system("tshark -r "+args.telemery_pcapng_file+" -T fields -e frame.number -e hbb.flow_id -e hbb.amt_bytes -e hbb.time_frame -E header=y -E separator=, > "+telemetry_pkts_csv)
